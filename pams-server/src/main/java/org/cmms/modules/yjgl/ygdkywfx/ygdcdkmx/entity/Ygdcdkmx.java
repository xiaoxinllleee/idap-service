package org.cmms.modules.yjgl.ygdkywfx.ygdcdkmx.entity;
 ...
 */
@Data
@TableName("Tb_dk_ygdcdksjmx")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Tb_dk_ygdcdksjmx对象", description="员工调查贷款明细")
public class Ygdcdkmx {
