package org.cmms.modules.yjgl.ygckywfx.ygzhckmx.entity;
 ...
 */
@Data
@TableName("Tb_ck_ygzhcksjmx")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Tb_ck_ygzhcksjmx对象", description="员工综合存款明细")
public class Ygzhckmx {
