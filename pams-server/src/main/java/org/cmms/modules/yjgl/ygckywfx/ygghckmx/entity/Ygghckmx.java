package org.cmms.modules.yjgl.ygckywfx.ygghckmx.entity;
...
@ApiModel(value="Tb_ck_ygghcksjmx对象", description="员工管户存款明细")
public class Ygghckmx {
	...
	/**员工工号*/
	@Excel(name = "管户员工姓名", width = 15,dicCode = "yggh", dictTable = "HR_BAS_STAFF", dicText = "ygxm")
