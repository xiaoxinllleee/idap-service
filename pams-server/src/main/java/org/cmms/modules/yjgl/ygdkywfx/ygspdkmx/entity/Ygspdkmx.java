package org.cmms.modules.yjgl.ygdkywfx.ygspdkmx.entity;
 ...
 */
@Data
@TableName("Tb_dk_ygspdksjmx")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Tb_dk_ygspdksjmx对象", description="员工审批贷款明细")
public class Ygspdkmx {
