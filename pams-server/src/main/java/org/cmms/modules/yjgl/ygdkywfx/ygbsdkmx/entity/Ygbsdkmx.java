package org.cmms.modules.yjgl.ygdkywfx.ygbsdkmx.entity;
 ...
 */
@Data
@TableName("Tb_dk_ygbsdksjmx")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Tb_dk_ygbsdksjmx对象", description="员工包收贷款明细")
public class Ygbsdkmx {
