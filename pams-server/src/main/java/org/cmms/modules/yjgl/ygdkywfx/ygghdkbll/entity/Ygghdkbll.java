package org.cmms.modules.yjgl.ygdkywfx.ygghdkbll.entity;
 ...
 */
@Data
@TableName("Tb_dk_ygghdkbll")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Tb_dk_ygghdkbll对象", description="员工管户贷款不良率")
public class Ygghdkbll {
