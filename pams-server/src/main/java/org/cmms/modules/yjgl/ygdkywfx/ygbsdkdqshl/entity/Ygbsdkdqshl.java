package org.cmms.modules.yjgl.ygdkywfx.ygbsdkdqshl.entity;
 ...
 */
@Data
@TableName("Tb_dk_ygbsdkdqshl")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Tb_dk_ygbsdkdqshl对象", description="员工包收贷款到期收回率")
public class Ygbsdkdqshl {
