package org.cmms.modules.hr.djpd.khjlxjpd.zbgl.zbsjgl.entity;
...
@ApiModel(value="GRADE_CUST_ZBSJ对象", description="指标数据管理")
public class ZbsjglVO {
//评定周期,评定日期,机构名称,客户经理标识,客户经理名称,指标ID,指标结果
	/**评定周期*/
