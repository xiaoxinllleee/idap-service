 ...
 */
@Data
@TableName("PMA_F_BASE_INDEX_TYPE")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="PMA_F_BASE_INDEX_TYPE对象", description="基础指标类型表")
public class PmaFBaseIndexType {
	...
	private List<PmaFBaseIndexType> child;
	@TableField(exist=false)
