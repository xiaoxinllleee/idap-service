...
function openScanFile(title,token,bizNo,archivesNo){
 	 //var pdfUrl ="http://127.0.0.1:8080/cmms/generic/web/viewer.html?file="+encodeURIComponent("http://127.0.0.1:8080/cmms/test/jeecgDemo/getPdfUrl?title="+encodeURI(title));
