package org.cmms.modules.message.job;

import java.util.List;

import org.cmms.common.util.DateUtils;
import org.cmms.modules.message.entity.SysMessage;
import org.cmms.modules.message.handle.ISendMsgHandle;
import org.cmms.modules.message.handle.enums.SendMsgStatusEnum;
import org.cmms.modules.message.handle.enums.SendMsgTypeEnum;
...
public class SendMsgJob implements Job {
	...
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		log.info(String.format(" cmms 发送消息任务 SendMsgJob !  时间:" + DateUtils.getTimestamp()));
