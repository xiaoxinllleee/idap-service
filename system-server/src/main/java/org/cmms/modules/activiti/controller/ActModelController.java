...
import org.cmms.modules.activiti.service.ActModelService;
...
public class ActModelController {
    ...
    public Result<Object> addModel(@RequestBody  ActModel actModel){
        ...
        actModel.setCreateBy(sysUser.getRealname());
    ...
    public Result<Object> deploy(@PathVariable String id) {
        ...
        try {
            ...
            for (ProcessDefinition pd : list) {
                ...
                actProcess.setCreateBy(sysUser.getRealname());
                actProcess.setCreateTime(new Date());
                actProcess.setUpdateTime(new Date());
