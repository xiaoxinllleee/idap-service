...
import org.cmms.modules.activiti.vo.ActPage;
import org.cmms.modules.activiti.vo.HistoricProcessInsVo;
import org.cmms.modules.activiti.vo.ProcessInsVo;
...
public class ActProcessInsController {
  ...
  /*  @Autowired
        ...
        list.forEach(e -> {
            ...
            for(HistoricIdentityLink hik : identityLinks){
                ...
                if("starter".equals(hik.getType())&& StrUtil.isNotBlank(hik.getUserId())){
                    ...
                    e.setApplyer(s.getRealname()).setApplyerUsername(s.getUsername());
                }
            }
            // 关联当前任务
    ...
    public Result<ProcessNodeVo> getFirstNode(@ApiParam("流程定义id") @PathVariable String procDefId,
        ...
        ProcessNodeVo node = actProcessService.getFirstNode(procDefId, tableId);
    ...
    public Result<ProcessNodeVo> getNextNode(@ApiParam("当前节点定义id") @PathVariable String procDefId,
        ...
        ProcessNodeVo node = actProcessService.getNextNode(procDefId, currActId, tableId);
        return new ResultUtil<ProcessNodeVo>().setData(node);
    }
