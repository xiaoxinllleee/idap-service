...
public interface SysUserMapper extends BaseMapper<SysUser> {
	...
	List<SysUser> findUserByRoleId( @Param("roleid") String roleid  ,@Param("org") String org );

	List<SysUser> findUsersByRoleId( @Param("roleid") String roleid );

	List<SysUser> findUserByPostAndOrg(@Param("gwbz")Integer gwbz, @Param("org")String org);

	//List<SysUser> findUserByRoleId( @Param("roleid") String roleid   );
  /* <select id="findUserByRoleId"  resultType="org.cmms.modules.system.entity.SysUser">
	...
	void updateUserPasswordVerify(@Param("entity") SysUser entity);

	List<SysUser> findIdapUserByRoleIdAndSszh(@Param("roleid")String roleId,@Param("sszh") String sszh);
}
