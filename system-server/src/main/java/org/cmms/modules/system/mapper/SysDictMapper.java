...
public interface SysDictMapper extends BaseMapper<SysDict> {
	...
	public List<String> queryTableDictTextByKey(@Param("table") String table, @Param("text") String text, @Param("code") String code, @Param("key") String key);

	public String queryTableDictTextByKeyByDsjpt(@Param("table") String table, @Param("text") String text, @Param("code") String code, @Param("key") String key);
	 ...
	 * @return
	 */
	List<TreeSelectModel> loadOrganTreeData(@Param("query") Map<String, String> query,
										@Param("table") String table,
										@Param("text") String text,
										@Param("code") String code,
										@Param("pidField") String pidField,
	...
	List<TreeSelectModel> queryTreeListToSszh(@Param("table") String table,
											  @Param("text") String text,
											  @Param("code") String code,
											  @Param("pidField") String pidField,
											  @Param("pid") String pid,
	 ...
	 * @return
	 */
	List<TreeSelectModel> queryZzjgTreeList(@Param("query") Map<String, String> query,
											@Param("table") String table,
											@Param("text") String text,
											@Param("code") String code,
											@Param("pidField") String pidField,
											@Param("pid") String pid,
											@Param("hasChildField") String hasChildField,
											@Param("getAllZzjg") String getAllZzjg);
	 ...
	 * 获取户号编码
	 */
	public String queryhhbm(@Param("text") String text);
