...
public class SysAnnouncementController {
	...
	public Result<IPage<SysAnnouncement>> queryPageList(SysAnnouncement sysAnnouncement,
		...
		if (StringUtils.isNotBlank(sysAnnouncement.getMsgCategory())){
			queryWrapper.eq("msg_category",sysAnnouncement.getMsgCategory());
		}
//		if(!sysAnnouncement.getMsgCategory().equals("0") && sysAnnouncement.getDelFlag().equals("0")){
//			queryWrapper.eq("msg_category",sysAnnouncement.getMsgCategory());
//		}
