...
import org.cmms.modules.system.mapper.SysPermissionMapper;
...
public class SysPermissionServiceImpl extends ServiceImpl<SysPermissionMapper, SysPermission> implements ISysPermissionService {
	...
	public List<SysPermission> queryByUser(String username, String subSystemId) {
		return this.sysPermissionMapper.queryByUser(username, subSystemId);
	}

	@Override

	public List<SysPermission> queryAllPermissionByUser(String username, String subSystemList) {
		return this.sysPermissionMapper.queryAllPermissionByUser(username, subSystemList);
	}

	@Override

	public List<SysSubSystem> querySubSystemByUser(String username) {
		return this.sysPermissionMapper.querySubSystemByUser(username);
	}
	...
	public List<SysPermission> queryHomePage() {
		return baseMapper.queryHomePage();
	}

	@Override
	public List<String> queryNavList(List<String> list) {
		List<String> list1 = baseMapper.queryNavList();
		List<String> intersection = list1.stream().filter(item -> list.contains(item)).collect(Collectors.toList());
		return intersection;
	}

	@Override
	public List<SysPermission> queryHomePageByUserName(String username) {
		return baseMapper.queryHomePageByUserName(username);
	}

	@Override
	public List<SysPermission> queryPadRouters(String username) {
		return baseMapper.queryPadRouters(username);
	}
}
