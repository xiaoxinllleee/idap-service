 ...
 */
@Data
@TableName("Khxxgl_khzhfx_yxzf")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Khxxgl_khzhfx_yxzf对象", description="有效走访明细")
public class YxzfKhzh {
	...
	/**有效走访日期*/
	@Excel(name = "有效走访日期", width = 15, format = "yyyy-MM-dd")
	@JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd")
    @DateTimeFormat(pattern="yyyy-MM-dd")
    @ApiModelProperty(value = "有效走访日期")
	private java.util.Date yxzfrq;
	/**有效走访人员*/
	@Excel(name = "有效走访人员", width = 15)
    @ApiModelProperty(value = "有效走访人员")
	private java.lang.String yxzfry;
	/**授信类型*/
