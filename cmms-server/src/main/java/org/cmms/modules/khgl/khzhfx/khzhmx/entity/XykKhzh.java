 ...
 */
@Data
@TableName("Khxxgl_khzhfx_xyk")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Khxxgl_khzhfx_xyk对象", description="信用卡信息明细")
public class XykKhzh {
	...
	private java.lang.String fkrq;
	/**激活日期*/
	@Excel(name = "激活日期", width = 15)
    @ApiModelProperty(value = "激活日期")
	private java.lang.String jhrq;
}
