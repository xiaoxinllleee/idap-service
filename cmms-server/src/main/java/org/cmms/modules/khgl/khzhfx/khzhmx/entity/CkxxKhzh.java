 ...
 */
@Data
@TableName("Khxxgl_khzhfx_ckxx")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Khxxgl_khzhfx_ckxx对象", description="存款信息明细")
public class CkxxKhzh {
	...
	/**存款机构*/
	@Excel(name = "存款机构", width = 15)
    @ApiModelProperty(value = "存款机构")
	private java.lang.String ckjg;
	/**定活标识*/
	@Excel(name = "定活标识", width = 15)
    @ApiModelProperty(value = "定活标识")
	private java.lang.String dhbs;
	/**存款余额*/
