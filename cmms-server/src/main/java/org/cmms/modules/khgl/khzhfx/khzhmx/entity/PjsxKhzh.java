 ...
 */
@Data
@TableName("Khxxgl_khzhfx_pjsx")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Khxxgl_khzhfx_pjsx对象", description="评级授信明细")
public class PjsxKhzh {
	...
	/**是否评级授信*/
	@Excel(name = "是否评级授信", width = 15)
    @ApiModelProperty(value = "是否评级授信")
	private java.lang.Integer sfpjsx;
	/**最终授信额度*/
	@Excel(name = "最终授信额度", width = 15)
    @ApiModelProperty(value = "最终授信额度")
	private java.lang.String nhzzsxed;
}
