 ...
 */
@Data
public class KhglQtzrrhmcxxPage {
...
//	private String khlx;
	...
	@ExcelCollection(name="其他自然人采集信息表")
	private List<CamsZcsxQtzrrcjxx> camsZcsxQtzrrcjxxList;
	@ExcelCollection(name="其他自然人房产信息")
	private List<Qtzrrfcxx> qtzrrfcxxList;
	@ExcelCollection(name="与我行相关业务")
	private List<Ywhywwlxx> ywhxgywList;
	@ExcelCollection(name="其他自然人评级授信信息")
	private List<QtzrrPjsxxx> qtzrrPjsxxxList;
	@ExcelCollection(name="其他自然人附件信息")
