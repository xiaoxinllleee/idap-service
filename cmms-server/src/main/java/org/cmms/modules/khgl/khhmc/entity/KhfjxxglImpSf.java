...
public class KhfjxxglImpSf {
    //姓名	身份证号码	是否吸毒	是否诉讼	是否五保低保户	是否特岗教师	是否党员	是否公职人员	是否服刑人员	是否诈骗人员	是否重大疾病
	/**客户名称*/
	...
	/**是否特岗教师*/
	@ApiModelProperty(value = "是否特岗教师")
	@Excel(name = "是否特岗教师", width = 15, dicCode = "sfbz")
	@Dict(dicCode = "sfbz")
