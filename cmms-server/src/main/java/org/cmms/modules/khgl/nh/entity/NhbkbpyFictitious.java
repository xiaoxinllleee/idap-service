...
public class NhbkbpyFictitious {
    /**主键ID*/
    ...
    /**评议员ID*/
    @Excel(name = "评议员ID", width = 15)
    @ApiModelProperty(value = "评议员ID")
    ...
    @Excel(name = "批量评议", width = 15)
    @ApiModelProperty(value = "批量评议")
    private String plpy;
    @Excel(name = "手机号码", width = 15)
    @ApiModelProperty(value = "手机号码")
    private String sjhm;
    @Excel(name = "评议员客户ID", width = 15)
    @ApiModelProperty(value = "评议员客户ID")
    ...
    /**是否复评*/
    @Excel(name = "是否复评", width = 15)
    @ApiModelProperty(value = "是否复评")
    private String sffp;
    /**客户类型*/
