 ...
 */
@Data
@TableName("Khxxgl_khzhfx_sjyh")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Khxxgl_khzhfx_sjyh对象", description="手机银行信息明细")
public class SjyhKhzh {
	...
	/**客户名词*/
	@Excel(name = "客户名词", width = 15)
    @ApiModelProperty(value = "客户名词")
