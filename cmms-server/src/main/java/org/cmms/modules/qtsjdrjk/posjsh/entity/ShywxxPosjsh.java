package org.cmms.modules.qtsjdrjk.posjsh.entity;
 ...
 */
@Data
@TableName("shywxx_posjsh")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="shywxx_posjsh对象", description="POS机商户")
public class ShywxxPosjsh {
