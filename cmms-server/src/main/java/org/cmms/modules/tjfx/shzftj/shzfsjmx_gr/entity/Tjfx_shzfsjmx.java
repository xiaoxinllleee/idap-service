package org.cmms.modules.tjfx.shzftj.shzfsjmx_gr.entity;
 ...
 */
@Data
@TableName("TJFX_SHZFSJMX")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="TJFX_SHZFSJMX对象", description="商户走访数据明细统计_客户经理")
public class Tjfx_shzfsjmx {
	...
	private String cjr;
	/**回访人*/
	@Excel(name = "回访人", width = 15,dicCode = "yggh", dictTable = "HR_BAS_STAFF", dicText = "ygxm")
    ...
    @ApiModelProperty(value = "是否有效走访(1:是 2:否)")
	@Dict(dicCode = "sfbz")
