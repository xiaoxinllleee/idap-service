package org.cmms.modules.tjfx.pjsxwcqkmxb.zhwcqkmxb.entity;
 ...
 */
@Data
@TableName("TJFX_PJSXWCQK_ZHMX")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="TJFX_PJSXWCQK_ZHMX对象", description="支行完成情况明细表")
public class PjsxwcqkZh {
	...
	private Long sjzfhs;
	/**支行户数*/
	@Excel(name = "支行户数", width = 15)
    @ApiModelProperty(value = "支行户数")
	private Long zhhs;
	/**采集率*/
