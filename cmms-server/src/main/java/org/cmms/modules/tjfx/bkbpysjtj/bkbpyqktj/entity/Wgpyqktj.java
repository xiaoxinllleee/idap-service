package org.cmms.modules.tjfx.bkbpysjtj.bkbpyqktj.entity;
 ...
 */
@Data
@TableName("KHXXGL_TJFX_BKBPY_WG")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="KHXXGL_TJFX_BKBPY_WG对象", description="评议情况统计(网格)")
public class Wgpyqktj {
