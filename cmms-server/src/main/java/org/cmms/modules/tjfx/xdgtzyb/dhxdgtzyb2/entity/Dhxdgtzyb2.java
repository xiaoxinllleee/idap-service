package org.cmms.modules.tjfx.xdgtzyb.dhxdgtzyb2.entity;
 ...
 */
@Data
@TableName("TJFX_ZHBEMXB_DH")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="TJFX_ZHBEMXB_DH对象", description="户行动挂图作业表2")
public class Dhxdgtzyb2 {
