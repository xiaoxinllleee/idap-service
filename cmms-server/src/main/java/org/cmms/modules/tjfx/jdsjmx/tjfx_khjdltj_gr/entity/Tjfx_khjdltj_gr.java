package org.cmms.modules.tjfx.jdsjmx.tjfx_khjdltj_gr.entity;
 ...
 */
@Data
@TableName("tjfx_khjdltj_gr")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="tjfx_khjdltj_gr对象", description="1")
public class Tjfx_khjdltj_gr {
