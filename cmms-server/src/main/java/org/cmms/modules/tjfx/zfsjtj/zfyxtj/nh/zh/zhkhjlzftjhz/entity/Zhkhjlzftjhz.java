package org.cmms.modules.tjfx.zfsjtj.zfyxtj.nh.zh.zhkhjlzftjhz.entity;
 ...
 */
@Data
@TableName("tjfx_zfsjtj_khjl_zh")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="tjfx_zfsjtj_khjl_zh对象", description="支行客户经理走访统计汇总")
public class Zhkhjlzftjhz {
