package org.cmms.modules.tjfx.zcsxtj.zcsxpcjdb.entity;
 ...
 */
@Data
@TableName("tjfx_zcsxjdb_pc")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="tjfx_zcsxjdb_pc对象", description="整村授信批次进度表")
public class Zcsxpcjdb {
