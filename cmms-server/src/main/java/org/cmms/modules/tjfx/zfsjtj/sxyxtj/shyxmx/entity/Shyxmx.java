package org.cmms.modules.tjfx.zfsjtj.sxyxtj.shyxmx.entity;
...
public class Shyxmx {
	...
	private String jgdm;
	/**hth*/
	@Excel(name = "hth", width = 15)
    @ApiModelProperty(value = "hth")
	private String hth;
	/**qyrq*/
	@Excel(name = "qyrq", width = 15, format = "yyyy-MM-dd")
	@JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd")
    @DateTimeFormat(pattern="yyyy-MM-dd")
    @ApiModelProperty(value = "qyrq")
	private Date qyrq;
	/**fkrq*/
	@Excel(name = "fkrq", width = 15, format = "yyyy-MM-dd")
	@JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd")
    @DateTimeFormat(pattern="yyyy-MM-dd")
    @ApiModelProperty(value = "fkrq")
	private Date fkrq;
	/**ffrq*/
	...
	/**dkpz*/
	@Excel(name = "dkpz", width = 15)
    @ApiModelProperty(value = "dkpz")
	private String dkpz;
	/**createBy*/
