package org.cmms.modules.tjfx.tjbb.jrphsjhz.jrphsj_zh.entity;
 ...
 */
@Data
@TableName("TJFX_JRPHSJ_ZH")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="TJFX_JRPHSJ_ZH对象", description="支行金融普惠数据汇总")
public class JrphsjZh {
	...
	/**7月贷款净增户*/
	@Excel(name = "当月贷款净增户", width = 15)
    @ApiModelProperty(value = "当月贷款净增户")
