package org.cmms.modules.tjfx.xdxtsxsjmx.xdxtkhsxtjzhmx.entity;
 ...
 */
@Data
@TableName("TJFX_XDXTKHSXYXTJ_ZHMX")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="TJFX_XDXTKHSXYXTJ_ZHMX对象", description="支行授信用信统计")
public class TjfxXdxtkhsxyctjZhmx {
