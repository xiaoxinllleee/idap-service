package org.cmms.modules.tjfx.bkbpysjtj.khbkbpyxzz.entity;
 ...
 */
@Data
@TableName("TJFX_KHBKBPY_XZZ")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="TJFX_KHBKBPY_XZZ对象", description="整组背靠背评议明细")
public class TjfxKhbkbpyXzz {
