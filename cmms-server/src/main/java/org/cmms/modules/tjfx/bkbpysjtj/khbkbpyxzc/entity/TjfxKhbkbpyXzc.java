package org.cmms.modules.tjfx.bkbpysjtj.khbkbpyxzc.entity;
 ...
 */
@Data
@TableName("TJFX_KHBKBPY_XZC")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="TJFX_KHBKBPY_XZC对象", description="整村背靠背评议明细")
public class TjfxKhbkbpyXzc {
