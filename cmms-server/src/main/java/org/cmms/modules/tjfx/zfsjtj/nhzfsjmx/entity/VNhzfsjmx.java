package org.cmms.modules.tjfx.zfsjtj.nhzfsjmx.entity;
...
/**
 * @Description: 农户走访数据明细视图
 * @Author: jeecg-boot
 * @Date:   2023-06-05
 * @Version: V1.0
 */
@Data
@TableName("V_TJFX_ZFSJMX_NH")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="V_TJFX_ZFSJMX_NH对象", description="农户走访数据明细视图")
public class VNhzfsjmx {
