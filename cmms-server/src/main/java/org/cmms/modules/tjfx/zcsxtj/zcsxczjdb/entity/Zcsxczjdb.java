 ...
 */
@Data
@TableName("tjfx_zcsxjdb_zu")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="tjfx_zcsxjdb_zu对象", description="整村授信村组进度表")
public class Zcsxczjdb {
...
//	@Excel(name = "较上周", width = 15,groupName = "背靠背初评")
	...
	/**支行审定惠农快贷比*/
	@Excel(name = "支行审定白名单导入惠农快贷比", width = 15,groupName = "惠农快贷")
    ...
    @ApiModelProperty(value = "惠农快贷签约率")
...
//	@Excel(name = "惠农快贷数据日期", width = 15, format = "yyyy-MM-dd")
	...
	/**精准营销完成比率*/
	@Excel(name = "精准营销完成比例", width = 15,groupName = "精准营销")
    ...
    @ApiModelProperty(value = "贷款合同较上月新增户数")
...
//	@Excel(name = "本周新增", width = 15,groupName = "新增用信")
    ...
    @ApiModelProperty(value = "新增用信额度汇总")
	private java.math.BigDecimal dkyxEdhz;
	/**用信新增有效用信客户数*/
	@Excel(name = "新增有效用信户数", width = 15,groupName = "新增用信")
