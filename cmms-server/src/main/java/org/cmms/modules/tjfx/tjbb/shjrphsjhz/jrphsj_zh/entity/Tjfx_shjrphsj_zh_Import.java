package org.cmms.modules.tjfx.tjbb.shjrphsjhz.jrphsj_zh.entity;
 ...
 */
@Data
@TableName("TJFX_SHJRPHSJ_ZH")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="TJFX_SHJRPHSJ_ZH对象", description="支行金融普惠数据")
public class Tjfx_shjrphsj_zh_Import {
