package org.cmms.modules.tjfx.xdxtsxsjmx.xdxtkhsxtjxzc.entity;
 ...
 */
@Data
@TableName("TJFX_XDXTKHSXYXTJ_XZC")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="TJFX_XDXTKHSXYXTJ_XZC对象", description="行政村授信用信统计")
public class XdxykhsxyxtjXzc {
