package org.cmms.modules.tjfx.shzftj.shzfsjmx_zh.entity;
 ...
 */
@Data
@TableName("TJFX_SHZFSJMX_ZH")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="TJFX_SHZFSJMX_ZH对象", description="商户走访数据明细统计_支行")
public class Tjfx_shzfsjmx_zh {
