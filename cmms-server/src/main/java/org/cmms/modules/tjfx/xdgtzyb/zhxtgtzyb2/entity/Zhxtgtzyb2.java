package org.cmms.modules.tjfx.xdgtzyb.zhxtgtzyb2.entity;
 ...
 */
@Data
@TableName("TJFX_ZHBEMXB_CMX")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="TJFX_ZHBEMXB_CMX对象", description="支行行动挂图作业表2")
public class Zhxtgtzyb2 {
