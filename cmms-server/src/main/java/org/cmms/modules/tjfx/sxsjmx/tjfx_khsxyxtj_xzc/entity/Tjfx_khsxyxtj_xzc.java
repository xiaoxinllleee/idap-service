package org.cmms.modules.tjfx.sxsjmx.tjfx_khsxyxtj_xzc.entity;
 ...
 */
@Data
@TableName("tjfx_khsxyxtj_xzc")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="tjfx_khsxyxtj_xzc对象", description="1")
public class Tjfx_khsxyxtj_xzc {
