package org.cmms.modules.tjfx.zfsjtj.zfyxtj.nh.zh.zhkhjlzftj.entity;
 ...
 */
@Data
@TableName("tjfx_zfyxtj_khjl_zh")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="tjfx_zfyxtj_khjl_zh对象", description="支行客户经理走访统计")
public class Zhkhjlzftj {
