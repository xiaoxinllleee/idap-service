package org.cmms.modules.tjfx.zcsxtj.zcsxzhjdb.entity;
 ...
 */
@Data
@TableName("tjfx_zcsxjdb_zh")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="tjfx_zcsxjdb_zh对象", description="整村授信支行进度表")
public class Zcsxzhjdb {
	...
	/**整村授信任务村个数*/
	@Excel(name = "整村授信任务村个数", width = 15)
    @ApiModelProperty(value = "整村授信任务村个数")
	private Integer zcsxrwcgs;
	/**村民小组个数*/
...
//	@Excel(name = "本周新增", width = 15, groupName = "背靠背初评")
	...
	@ApiModelProperty(value = "初评完成小组个数")
	private Integer bkbcpWcxzgs;
	/**初评授信对象人数*/
	//@Excel(name = "初评授信对象人数", width = 15)
...
//	@Excel(name = "较上周", width = 15,groupName = "背靠背初评")
	...
	/**支行审定授信对象人数*/
	//@Excel(name = "支行审定授信对象人数", width = 15)
    @ApiModelProperty(value = "支行审定授信对象人数")
	private Integer zhsdSxdxrs;
	/**支行审定额度汇总*/
	@Excel(name = "支行审定额度汇总(万元)", width = 15,groupName = "行内审定")
    @ApiModelProperty(value = "支行审定额度汇总")
	private java.math.BigDecimal zhsdEdhz;
	/**支行审定完成村个数*/
	@Excel(name = "完成村个数", width = 15,groupName = "行内审定")
	@ApiModelProperty(value = "完成村个数")
	private Integer zhsdWccgs;
	/**支行审定完成比例*/
	@Excel(name = "行政村行内审定完成比例", width = 15,groupName = "行内审定")
    @ApiModelProperty(value = "行政村行内审定完成比例")
	private java.math.BigDecimal zhsdWcbl;
	/**惠农快贷导入户数*/
	...
	/**支行审定惠农快贷比*/
	@Excel(name = "支行审定惠农快贷比", width = 15,groupName = "惠农快贷")
    @ApiModelProperty(value = "支行审定惠农快贷比")
...
//	@Excel(name = "惠农快贷数据日期", width = 15, format = "yyyy-MM-dd")
    ...
    @ApiModelProperty(value = "贷款合同新增客户数")
...
//	@Excel(name = "本周新增", width = 15,groupName = "新增用信")
	...
	/**用信新增有效用信客户数*/
	@Excel(name = "新增有效用信客户数", width = 15,groupName = "新增用信")
    @ApiModelProperty(value = "用信新增有效用信客户数")
...
//	@Excel(name = "本周新增", width = 15,groupName = "新增用信")
	...
	/**授信验收验收合格村个数*/
	@Excel(name = "验收合格村个数", width = 15,groupName = "整村授信验收")
    @ApiModelProperty(value = "验收合格村个数")
	private Integer sxysYshgcgs;
	/**授信验收验收合格率*/
	@Excel(name = "验收合格率", width = 15,groupName = "整村授信验收")
    @ApiModelProperty(value = "验收合格率")
	private java.math.BigDecimal sxysYshgl;
	/**年份*/
