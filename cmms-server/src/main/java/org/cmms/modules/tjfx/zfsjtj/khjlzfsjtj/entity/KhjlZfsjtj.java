package org.cmms.modules.tjfx.zfsjtj.khjlzfsjtj.entity;
 ...
 */
@Data
@TableName("tjfx_zfsjtj_khjl")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="tjfx_zfsjtj_khjl对象", description="客户经理走访数据统计")
public class KhjlZfsjtj {
