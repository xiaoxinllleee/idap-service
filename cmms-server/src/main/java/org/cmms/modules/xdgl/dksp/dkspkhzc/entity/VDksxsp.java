 ...
 */
@Data
@TableName("v_cams_dksp_khzc_sxsp")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="v_cams_dksp_khzc_sxsp对象", description="贷款授信审批")
public class VDksxsp {
	...
	private String dz;
	/**信用等级*/
	@Excel(name = "信用等级", width = 15,dicCode = "rate_xydj")
	...
	private String jkfs;
	/**贷款期限*/
	@Excel(name = "贷款期限", width = 15,dicCode = "khgl_dkqx")
	@ApiModelProperty(value = "贷款期限")
	@Dict(dicCode = "khgl_dkqx")
	private String dkqx;
	/**贷款金额*/
	...
	/**贷款种类*/
	@Excel(name = "贷款种类", width = 15,dicCode = "dkzl")
