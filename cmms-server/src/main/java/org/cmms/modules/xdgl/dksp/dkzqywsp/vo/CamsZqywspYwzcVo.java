package org.cmms.modules.xdgl.dksp.dkzqywsp.vo;
 ...
 */
@Data
@TableName("CAMS_ZQYWSP_YWZC")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="CAMS_ZQYWSP_YWZC对象", description="贷款展期业务审批注册表")
public class CamsZqywspYwzcVo {
