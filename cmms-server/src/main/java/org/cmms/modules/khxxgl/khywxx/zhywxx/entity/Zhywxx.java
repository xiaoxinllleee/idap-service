 ...
 */
@Data
@TableName("KHXXGL_YWHYWWLXX_DAY_ZH")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="KHXXGL_YWXX_ZH对象", description="支行业务信息")
public class Zhywxx {
	...
	/**是否开通便民卡*/
	@Excel(name = "是否开通便民卡", width = 15)
    @ApiModelProperty(value = "是否开通便民卡")
	private java.lang.String sfktbmk;
}
