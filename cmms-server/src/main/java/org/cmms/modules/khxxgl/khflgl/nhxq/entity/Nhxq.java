...
public class Nhxq {
	...
	@Dict(dicCode = "hyzk", dicCodeQybm = "020=hyzk_cj")
	private String hyzk;
	/**户口性质*/
	...
	@ApiModelProperty(value = "职业")
	@Dict(dicCode = "app_zc",dicCodeQybm = "020=cszy")
	private String cszy;
	...
	@TableField(exist = false)
	@ApiModelProperty(value = "是否移除农户")
	private String sfycnh;
}
