package org.cmms.modules.khxxgl.clkhxx.entity;
 ...
 */
@Data
@TableName("KHXXGL_CLKHXX")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="KHXXGL_CLKHXX对象", description="存量客户管理")
public class Clkhgl {
	...
	/**所属机构*/
	@Excel(name = "所属机构", width = 15, dicCode="ywjgdm",dictTable="hr_bas_organization",dicText="zzjc")
	...
	/**证件类型*/
	@Excel(name = "证件类型", width = 15, dicCode = "hxzjlx")
