package org.cmms.modules.ckjkpt.khgl.jgckhztj.entity;
 ...
 */
@Data
@TableName("ckjkpt_khfz_jgckhz")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="ckjkpt_khfz_jgckhz对象", description="机构存款汇总统计")
public class CkjkptKhfzJgckhz {
