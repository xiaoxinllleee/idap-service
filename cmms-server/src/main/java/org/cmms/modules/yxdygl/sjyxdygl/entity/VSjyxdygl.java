 ...
 */
@Data
@TableName("v_yxdygl_sjyxdygl")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="v_yxdygl_sjyxdygl对象", description="三级营销单元管理")
public class VSjyxdygl {
...
//	@Excel(name = "二级营销单元编号", width = 15)
	...
	/**二级营销单元名称*/
	@Excel(name = "二级营销单元", width = 15)
    @ApiModelProperty(value = "二级营销单元名称")
	private String ejyxdymc;
	/**单元编号*/
