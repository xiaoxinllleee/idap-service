...
public class Lldjsq {
	...
	/**上年授信额度*/
	@Excel(name = "上年授信额度(万元)", width = 15, numFormat = ",##0.00")
	@ApiModelProperty(value = "上年授信额度")
	private java.math.BigDecimal snsxed;
	/**上年贷款利率上浮幅度*/
	@Excel(name = "上年贷款利率上浮幅度(%)", width = 15, numFormat = "#0.00")
	...
	/**其中：贷款授信+承兑敞口*/
	@Excel(name = "其中：贷款授信+承兑敞口(万元)", width = 15, numFormat = ",##0.00")
