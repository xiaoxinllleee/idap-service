package org.cmms.modules.khpjsx.pjsjxsjxarea.entity;
 ...
 */
@Data
@TableName("PJSX_SJXXXB_AREA")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="PJSX_SJXXXB_AREA对象", description="区域数据项")
public class PjsxSjxArea {
