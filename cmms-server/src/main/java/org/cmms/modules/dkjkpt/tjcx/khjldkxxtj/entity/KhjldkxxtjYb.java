 ...
 */
@Data
@TableName("Tb_dk_dyzrrkhjldkxxtjyb")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Tb_dk_dyzrrkhjldkxxtjyb对象", description="客户经理贷款信息统计月报")
public class KhjldkxxtjYb {
	/**统计月份*/
	...
	/**客户新增数*/
	@Excel(name = "客户新增数", width = 15)
    @ApiModelProperty(value = "客户新增数")
	...
	private java.math.BigDecimal zye;
	/**总金额*/
	@Excel(name = "贷款总金额", width = 15)
	...
	private java.math.BigDecimal cldkhs;
	/**存量贷款余额*/
	...
	private java.math.BigDecimal zcldkhs;
	/**正常类贷款占比*/
	@Excel(name = "正常类贷款占比", width = 15)
	@ApiModelProperty(value = "正常类贷款占比")
	...
	private java.math.BigDecimal gzldkhs;
	/**关注贷款占比*/
