package org.cmms.modules.dkjkpt.dksjjk.fxgljc.yqjjgzl.entity;
 ...
 */
@Data
@TableName("FXGLJC_YQJJGZL")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="FXGLJC_YQJJGZL对象", description="利息、本金逾期将进关注类")
public class FxgljcYqjjgzl {
