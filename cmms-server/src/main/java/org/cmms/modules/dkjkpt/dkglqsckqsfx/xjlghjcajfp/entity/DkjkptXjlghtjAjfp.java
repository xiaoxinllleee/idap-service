package org.cmms.modules.dkjkpt.dkglqsckqsfx.xjlghjcajfp.entity;
 ...
 */
@Data
@TableName("Dkjkpt_xjlghtj_ajfp")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Dkjkpt_xjlghtj_ajfp对象", description="现金流归行监测（按揭、扶贫）")
public class DkjkptXjlghtjAjfp {
