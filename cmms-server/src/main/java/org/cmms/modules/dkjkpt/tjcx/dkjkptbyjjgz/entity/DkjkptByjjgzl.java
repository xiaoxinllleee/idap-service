package org.cmms.modules.dkjkpt.tjcx.dkjkptbyjjgz.entity;
 ...
 */
@Data
@TableName("FXGLJC_BYJJGZL")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="FXGLJC_BYJJGZL对象", description="本月将进关注")
public class DkjkptByjjgzl {
	...
	private String dkxt;
	/**是否按揭（1：是 2：否）*/
	@Excel(name = "是否按揭（1：是 2：否）", width = 15,dicCode = "sfbz")
    @ApiModelProperty(value = "是否按揭（1：是 2：否）")
	@Dict(dicCode = "sfbz")
	private String sfaj;
	/**第一责任人*/
