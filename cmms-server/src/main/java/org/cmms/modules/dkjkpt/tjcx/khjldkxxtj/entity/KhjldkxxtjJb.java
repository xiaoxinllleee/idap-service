 ...
 */
@Data
@TableName("Tb_dk_dyzrrkhjldkxxtjjb")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Tb_dk_dyzrrkhjldkxxtjjb对象", description="客户经理贷款信息统计季报")
public class KhjldkxxtjJb {
	...
	/**关注贷款占比 = 关注类贷款余额/贷款总额×100%*/
	@Excel(name = "关注贷款占比 = 关注类贷款余额/贷款总额×100%", width = 15)
	@ApiModelProperty(value = "关注贷款占比 = 关注类贷款余额/贷款总额×100%")
	...
	/**当期贷款到期收回率 = 当期贷款回收额/当期到期贷款总额×100%*/
