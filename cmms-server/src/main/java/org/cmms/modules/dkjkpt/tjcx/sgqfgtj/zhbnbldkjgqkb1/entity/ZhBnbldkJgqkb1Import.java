package org.cmms.modules.dkjkpt.tjcx.sgqfgtj.zhbnbldkjgqkb1.entity;
 ...
 */
@Data
@TableName("REP_YWBB_ZHBNBLDKJGQKB1")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="REP_YWBB_ZHBNBLDKJGQKB1对象", description="支行表内不良贷款结构情况表1")
public class ZhBnbldkJgqkb1Import {
