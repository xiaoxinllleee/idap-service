...
/**
 * @Description: 不良贷款反弹监控（比上年末）
 * @Author: cmms
 * @Date:   2019-09-11
 * @Version: V1.0
 */
@Data
@TableName("DKJKPT_BLDKFTJKB_BSNM")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="DKJKPT_BLDKFTJKB_BSNM对象", description="不良贷款反弹监控比上年末")
public class DkjkptBldkftjkBsnm {
    ...
    /**上年末贷款形态*/
    @Excel(name = "上年末贷款形态", width = 15,dicCode = "dkxt")
    @ApiModelProperty(value = "上年末贷款形态")
	@Dict(dicCode = "dkxt")
	private Integer snmdkxt;
    /**上年末时间*/
    ...
    private Date snmsj;
	/**当天贷款形态*/
	@Excel(name = "当天贷款形态", width = 15,dicCode = "dkxt")
    @ApiModelProperty(value = "当天贷款形态")
	@Dict(dicCode = "dkxt")
