package org.cmms.modules.dkjkpt.dhgzfjxx.yqdkcs.entity;
 ...
 */
@Data
@TableName("V_dkjkpt_yqdkcstzs")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="V_dkjkpt_yqdkcstzs对象", description="1")
public class VdkjkptYqdkcstzs {
