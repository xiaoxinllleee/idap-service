package org.cmms.modules.dkjkpt.tjcx.ygghdkxxtj.entity;
 ...
 */
@Data
@TableName("Tb_dk_khjldkxxtjyb")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Tb_dk_khjldkxxtjyb对象", description="员工管户贷款信息统计月报")
public class YgghdkxxtjYb {
	/**统计月份*/
	...
	/**累计应收利息*/
	//@Excel(name = "累计应收利息", width = 15)
    @ApiModelProperty(value = "累计应收利息")
	private java.math.BigDecimal ljyslx;
}
