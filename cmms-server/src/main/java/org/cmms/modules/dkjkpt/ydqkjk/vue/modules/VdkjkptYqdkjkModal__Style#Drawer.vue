    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="dkzh">
          <a-input placeholder="请输入dkzh" v-decorator="['dkzh', validatorRules.dkzh ]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="qxr">
          <a-date-picker v-decorator="[ 'qxr', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="jxr">
          <a-input placeholder="请输入jxr" v-decorator="['jxr', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="syts">
          <a-input placeholder="请输入syts" v-decorator="['syts', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="dhhm">
          <a-input placeholder="请输入dhhm" v-decorator="['dhhm', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
          label="xddkpz">
          <a-input placeholder="请输入xddkpz" v-decorator="['xddkpz', {}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
  ...
  export default {
    ...
    data () {
      return {
        ...
        validatorRules:{
        dkzh:{rules: [{ required: true, message: '请输入dkzh!' }]},
        },
        url: {
          add: "/dkjkpt.ydqkjk/vdkjkptYqdkjk/add",
          edit: "/dkjkpt.ydqkjk/vdkjkptYqdkjk/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'jgdm','khmc','zjhm','dkzh','bmkkh','dkje','dkye','jxr','syts','khlx','dz','dhhm','xddkpz','khjlyggh'))
		  //时间格式化
