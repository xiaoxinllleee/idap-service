package org.cmms.modules.dkjkpt.cssz.dkqxcssz.entity;
 ...
 */
@Data
@TableName("DKJKPT_DKQXCSSZ")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="DKJKPT_DKQXCSSZ对象", description="贷款期限参数设置")
public class Dkjkpt_dkqxcssz {
