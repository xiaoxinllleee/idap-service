package org.cmms.modules.dkjkpt.tjcx.sgqfgtj.qhckjgqkb.entity;
 ...
 */
@Data
@TableName("REP_YWBB_QHCKJGQKB")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="REP_YWBB_QHCKJGQKB对象", description="全行存款结构情况表")
public class RepYwbbQhckjgqkbImport {
