package org.cmms.modules.dkjkpt.tjcx.sgqfgtj.qhzcdkjgqkb.entity;
 ...
 */
@Data
@TableName("REP_YWBB_QHZCDKJGQKB")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="REP_YWBB_QHZCDKJGQKB对象", description="全行正常贷款结构情况表")
public class RepYwbbQhzcdkjgqkbImport {
