...
/**
 * @Description: 不良贷款反弹监控（比昨日）
 * @Author: cmms
 * @Date:   2019-09-10
 * @Version: V1.0
 */
@Data
@TableName("DKJKPT_BLDKFTJKB_BSR")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="DKJKPT_BLDKFTJKB_BSR对象", description="不良贷款反弹监控比昨日")
public class DkjkptBldkftjkBsr {
    ...
    /**昨日贷款形态*/
    @Excel(name = "昨日贷款形态", width = 15, dicCode = "dkxt")
    @ApiModelProperty(value = "昨日贷款形态")
    @Dict(dicCode = "dkxt")
    private Integer zrdkxt;
    /**昨日时间*/
