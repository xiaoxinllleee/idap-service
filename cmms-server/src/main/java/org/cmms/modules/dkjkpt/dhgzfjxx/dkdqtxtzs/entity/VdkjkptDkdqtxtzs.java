package org.cmms.modules.dkjkpt.dhgzfjxx.dkdqtxtzs.entity;
 ...
 */
@Data
@TableName("V_dkjkpt_dkdqtxtzs")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="V_dkjkpt_dkdqtxtzs对象", description="1")
public class VdkjkptDkdqtxtzs {
