...
/**
 * @Description: 支行不良贷款反弹监控比上月
 * @Author: cmms
 * @Date:   2019-09-11
 * @Version: V1.0
 */
@Data
@TableName("V_dkjkpt_zhbldkftjk_bsy")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="V_dkjkpt_zhbldkftjk_bsy对象", description="支行不良贷款反弹监控比上月")
public class DkjkptZhbldkftjkBsy {
