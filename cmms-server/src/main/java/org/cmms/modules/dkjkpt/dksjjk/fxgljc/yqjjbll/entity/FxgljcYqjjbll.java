package org.cmms.modules.dkjkpt.dksjjk.fxgljc.yqjjbll.entity;
 ...
 */
@Data
@TableName("FXGLJC_YQJJBLL")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="FXGLJC_YQJJBLL对象", description="利息、本金逾期将进不良类")
public class FxgljcYqjjbll {
