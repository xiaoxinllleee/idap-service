 ...
 */
@Data
@TableName("KHXXGL_JZYX_ECZF_C")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="KHXXGL_JZYX_ECZF_C对象", description="二次走访过滤原始数据")
public class EczfSjGlmx {
	...
	@TableField(value = "TLSJ")
	private Integer tlsj;

	@TableField(value = "ZFYXFS")
	@Dict(dicCode = "zfyxfs")
	private String zfyxfs;

	@TableField(value = "JYGM")
	private String jygm;

	@TableField(value = "ZYSRLY")
	private String zysrly;
	@TableField(value = "GRNSR")
	@Dict(dicCode = "bkbpy_sr")
	private String grnsr;
	@TableField(value = "JTNSR")
	@Dict(dicCode = "bkbpy_sr")
	...
	/**是否存款客户*/
	@Excel(name = "是否存款客户", width = 15)
    @ApiModelProperty(value = "是否存款客户")
	private java.lang.String sfckkh;
	/**存款余额*/
	@Excel(name = "存款余额", width = 15)
    @ApiModelProperty(value = "存款余额")
	private java.math.BigDecimal ckye;
	/**是否贷款客户*/
	@Excel(name = "是否贷款客户", width = 15)
    @ApiModelProperty(value = "是否贷款客户")
	private java.lang.String sfdkkh;
	/**贷款金额*/
	...
	private java.lang.String sfblsbk;
	/**是否开通手机银行*/
