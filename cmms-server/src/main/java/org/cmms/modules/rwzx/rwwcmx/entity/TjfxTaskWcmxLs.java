 ...
 */
@Data
@TableName("TJFX_TASK_WCMX_LS")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="TJFX_TASK_WCMX_LS对象", description="统计分析-任务完成明细_蓝山")
public class TjfxTaskWcmxLs {
	...
	/**转化率累计成功*/
	@Excel(name = "转化率累计成功", width = 15)
    @ApiModelProperty(value = "转化率累计成功")
	private Integer zhlljcg;
}
