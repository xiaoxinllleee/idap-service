package org.cmms.modules.pad.khxxcjys.jtnc.entity;
 ...
 */
@Data
@TableName("KHXXCJYS_JTNC")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="KHXXCJYS_JTNC对象", description="客户信息采集要素_家庭农场")
public class KhxxcjysJtnc {
