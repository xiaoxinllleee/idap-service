...
public class YxglKhhfxxb {
	...
	/**客户所属支行*/
	@Excel(name = "客户所属支行", width = 15)
	@ApiModelProperty(value = "客户所属支行")
	@Dict(dicCode="ZZBZ", dictTable="HR_BAS_ORGANIZATION", dicText="ZZJC")
	private String khsszh;


	/**归属情况*/
	@Excel(name = "归属情况", width = 15,dicCode = "gsqk")
	@ApiModelProperty(value = "归属情况")
	@Dict(dicCode = "gsqk")
	private String gsqk;

	/**走访原因*/
	@Excel(name = "走访原因", width = 15,dicCode = "zfyy")
