...
/**
 * @Description: 公职人员回访信息表
 * @Author: jeecg-boot
 * @Date:   2022-08-30
 * @Version: V1.0
 */
@Data
@TableName("YXGL_GZRYHFXXB")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="YXGL_GZRYHFXXB对象", description="公职人员回访信息表")
public class Gzryhfxxb {
	...
	/**xzzfy*/
	@Excel(name = "xzzfy", width = 15)
    @ApiModelProperty(value = "xzzfy")
	private String xzzfy;
	/**公职人员id*/
