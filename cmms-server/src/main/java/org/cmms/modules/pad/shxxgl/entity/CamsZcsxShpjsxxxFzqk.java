...
/**
 * @Description: 商户评级授信-负债情况
 * @Author: jeecg-boot
 * @Date:   2023-09-14
 * @Version: V1.0
 */
@Data
@TableName("CAMS_ZCSX_SHPJSXXX_FZQK")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="CAMS_ZCSX_SHPJSXXX_FZQK对象", description="商户评级授信-负债情况")
public class CamsZcsxShpjsxxxFzqk {
