package org.cmms.modules.pad.khxxcjys.xwqy.entity;
 ...
 */
@Data
@TableName("KHXXCJYS_XWQY")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="KHXXCJYS_XWQY对象", description="客户信息采集要素_小微企业")
public class KhxxcjysXwqy {
	...
	/**企业基本账户开立行*/
	@Excel(name = "企业基本账户开立行", width = 15)
    @ApiModelProperty(value = "企业基本账户开立行")
	private String qyjbzhklh;
	/**借款主体名字*/
