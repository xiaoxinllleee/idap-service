...
@ApiModel(value="cams_zcsx_nhpjsxxx对象", description="1")
public class CamsZcsxNhpjsxxxPad {
	...
	/**种植成品数量*/
	@Excel(name = "种植成品数量", width = 15)
	@ApiModelProperty(value = "种植成品数量")
	private String zzcpsl;
	/**种植成品价值*/
	@Excel(name = "种植成品价值", width = 15)
	@ApiModelProperty(value = "种植成品价值")
	private String zzcpjz;
	/**种植成品详情说明*/
	@Excel(name = "种植成品详情说明", width = 15)
	@ApiModelProperty(value = "种植成品详情说明")
	private String zzcpxqsm;
	/**养殖成品数量*/
	@Excel(name = "养殖成品数量", width = 15)
	@ApiModelProperty(value = "养殖成品数量")
	private String yzcpsl;
	/**养殖成品价值*/
	@Excel(name = "养殖成品价值", width = 15)
	@ApiModelProperty(value = "养殖成品价值")
	private String yzcpjz;
	/**养殖成品详情说明*/
	@Excel(name = "养殖成品详情说明", width = 15)
	@ApiModelProperty(value = "养殖成品详情说明")
	private String yzcpxqsm;
	/**租金项目情况*/
	@Excel(name = "租金项目情况", width = 15)
	@ApiModelProperty(value = "租金项目情况")
	private String zjxmqk;
	/**租金项目年收入*/
	@Excel(name = "租金项目年收入", width = 15)
	@ApiModelProperty(value = "租金项目年收入")
	private String zjxmsr;
	/**租金项目年支出*/
	@Excel(name = "租金项目年支出", width = 15)
	@ApiModelProperty(value = "租金项目年支出")
	private String zjxmzc;
	/**租金项目净收入*/
	@Excel(name = "租金项目净收入", width = 15)
	@ApiModelProperty(value = "租金项目净收入")
	private String zjxmjsr;
	/**国家补贴项目情况*/
	@Excel(name = "国家补贴项目情况", width = 15)
	@ApiModelProperty(value = "国家补贴项目情况")
	private String gjbtxmqk;
	/**国家补贴项目年收入*/
	@Excel(name = "国家补贴项目年收入", width = 15)
	@ApiModelProperty(value = "国家补贴项目年收入")
	private String gjbtxmsr;
	/**国家补贴项目年支出*/
	@Excel(name = "国家补贴项目年支出", width = 15)
	@ApiModelProperty(value = "国家补贴项目年支出")
	private String gjbtxmzc;
	/**国家补贴项目净收入*/
	@Excel(name = "国家补贴项目净收入", width = 15)
	@ApiModelProperty(value = "国家补贴项目净收入")
	private String gjbtxmjsr;
	/**资产负债率*/
