 ...
 */
@Data
@TableName("CAMS_ZCSX_SHPJSXXX")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="CAMS_ZCSX_SHPJSXXX对象", description="商户评级授信信息")
public class CamsZcsxShpjsxxx {
	...
	private String jynx;
	/**与行内往来状况*/
	@Excel(name = "与行内往来状况", width = 15)
	@ApiModelProperty(value = "与行内往来状况")
	private String yhnwlzk;
	/**诚信度*/
	@Excel(name = "诚信度", width = 15)
	@ApiModelProperty(value = "诚信度")
	private String cxd;
	/**年利润*/
