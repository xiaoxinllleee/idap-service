...
@ApiModel(value="V_KHGL_SHXXGL对象", description="商户信息视图")
public class VKhglShxxgl {
	...
	private String shfl;
	/**是否完成评级授信*/
	@Excel(name = "是否完成评级授信", width = 15,dicCode = "sfbz")
	@ApiModelProperty(value = "是否完成评级授信")
	@Dict(dicCode = "sfbz")
	private String sfwcpjsx;
	/**客户经理评定等级*/
