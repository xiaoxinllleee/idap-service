package org.cmms.modules.pad.khxxcjys.hzs.entity;
 ...
 */
@Data
@TableName("KHXXCJYS_HZS")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="KHXXCJYS_HZS对象", description="客户信息采集要素_合作社")
public class Khxxcjhzs {
	...
	/**与企业主体关系*/
	@Excel(name = "与企业主体关系", width = 15)
    @ApiModelProperty(value = "与企业主体关系")
	private String yqyztgx;
	/**录入标识*/
