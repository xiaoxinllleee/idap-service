...
@ApiModel(value="KHXXGL_YWHYWWLXX对象", description="1")
public class KhglYwhywwlxxPad {
	...
	/**最早发放贷款日期*/
	@Excel(name = "最早发放贷款日期", width = 15, format = "yyyy-MM-dd")
	@JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd")
	@DateTimeFormat(pattern="yyyy-MM-dd")
	@ApiModelProperty(value = "最早发放贷款日期")
