...
@Slf4j
@Component
public class FyftjzImportVerifys implements IExcelVerifyHandler {
    @Autowired
    ...
    public ExcelVerifyHanlderResult verifyHandler(Object var1, String var2, Object var3) {
        ...
        if (form != null) {
            ...
            org = hrBasOrganizationService.getOne(orgQueryWrapper,false);
            if (org == null) {
            ...
            // 导入业务机构不是本人所在机构
            if (!oprYwjgdm.equals(form.getJgdm())) {
                result.setSuccess(false);
                result.setMsg("不允许导入本业务机构外的业务数据！");
                return result;
            }
