package org.cmms.modules.xddagl.dkdagl.cldkhtsjgl.entity;
...
@ApiModel(value="XDDAGL_DAZLFJXX对象", description="存量贷款合同数据管理附件信息")
public class CldkhtsjglFjxx {
