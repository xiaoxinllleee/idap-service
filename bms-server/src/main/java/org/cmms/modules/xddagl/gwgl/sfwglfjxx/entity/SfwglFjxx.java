package org.cmms.modules.xddagl.gwgl.sfwglfjxx.entity;
 ...
 */
@Data
@TableName("XDDAGL_SFWGLFJXX")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="XDDAGL_SFWGLFJXX对象", description="收发文管理附件信息")
public class SfwglFjxx {
	...
	private String wjid;
	/**发文编号id*/
	@Excel(name = "发文编号id", width = 15)
    @ApiModelProperty(value = "发文编号id")
	private String fwbhid;
	/**文件路径*/
