package org.cmms.modules.lydp.zbgl.lydpQyzbsjx.entity;
 ...
 */
@Data
@TableName("REP_INDEX_SJX_AREA_LYDP")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="REP_INDEX_SJX_AREA_LYDP对象", description="浏阳大屏指标区域数据项")
public class LydpQyzbsjx {
