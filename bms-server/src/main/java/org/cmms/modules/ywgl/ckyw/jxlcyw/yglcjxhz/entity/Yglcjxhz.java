package org.cmms.modules.ywgl.ckyw.jxlcyw.yglcjxhz.entity;
 ...
 */
@Data
@TableName("ERP_BAS_YGLCJXHZ")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="ERP_BAS_YGLCJXHZ对象", description="员工揽储绩效汇总")
public class Yglcjxhz {
