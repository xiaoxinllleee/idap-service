package org.cmms.modules.ywgl.cdkfx.khjlcdktjjg.controller;
...
import io.swagger.annotations.ApiOperation;
 ...
 /**
 * @Description: 客户经理存贷款分析（机构）
 * @Author: jeecg-boot
 * @Date:   2021-06-15
 * @Version: V1.0
 */
@Slf4j
@Api(tags="客户经理存贷款分析（机构）")
@RestController
@RequestMapping("/khjlcdktjjg/erpYljcJgkhjldkkhzbtj")
public class ErpYljcJgkhjldkkhzbtjController extends JeecgController<ErpYljcJgkhjldkkhzbtj, IErpYljcJgkhjldkkhzbtjService> {
	 @Autowired
	 private IErpYljcJgkhjldkkhzbtjService erpYljcJgkhjldkkhzbtjService;
	 @Autowired
	 ...
	 * @return
	 */
	@AutoLog(value = "客户经理存贷款分析（机构）-分页列表查询")
	@ApiOperation(value="客户经理存贷款分析（机构）-分页列表查询", notes="客户经理存贷款分析（机构）-分页列表查询")
	@GetMapping(value = "/list")
	public Result<?> queryPageList(ErpYljcJgkhjldkkhzbtj erpYljcJgkhjldkkhzbtj,
								   @RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
								   @RequestParam(name="pageSize", defaultValue="10") Integer pageSize,
								   HttpServletRequest req) {
		Result<IPage<ErpYljcJgkhjldkkhzbtj>> result = new Result<IPage<ErpYljcJgkhjldkkhzbtj>>();
		QueryWrapper<ErpYljcJgkhjldkkhzbtj> queryWrapper = QueryGenerator.initQueryWrapper(erpYljcJgkhjldkkhzbtj, req.getParameterMap());
		...
		IPage pageList = PageUtil.toPage(IErpYljcJgkhjldkkhzbtjService.class,erpYljcJgkhjldkkhzbtjService, pageNo, pageSize, queryWrapper, "YWJGDM","JGDM");
	  ...
	  * @return
	  */
	 @AutoLog(value = "客户经理存贷款分析（机构）-提取")
	 @ApiOperation(value="客户经理存贷款分析（机构）-提取", notes="客户经理存贷款分析（机构）-提取")
	 ...
	 public Result<?> count(@RequestParam(name = "jgdm", required = false) String jgdm,
		 ...
		 if ("true".equalsIgnoreCase(sfdsjpt)) {
			 ...
			 try {
				 erpYljcJgkhjldkkhzbtjService.pAutoExec(jgdm, i_tjyf, loginUser.getRealname());
	 ...
	 * @return
	 */
	@AutoLog(value = "机构客户经理指标统计(机构)-添加")
	@ApiOperation(value="机构客户经理指标统计(机构)-添加", notes="机构客户经理指标统计(机构)-添加")
	@PostMapping(value = "/add")
	public Result<?> add(@RequestBody ErpYljcJgkhjldkkhzbtj erpYljcJgkhjldkkhzbtj) {
		erpYljcJgkhjldkkhzbtjService.save(erpYljcJgkhjldkkhzbtj);
	 ...
	 * @return
	 */
	@AutoLog(value = "机构客户经理指标统计(机构)-编辑")
	@ApiOperation(value="机构客户经理指标统计(机构)-编辑", notes="机构客户经理指标统计(机构)-编辑")
	@PutMapping(value = "/edit")
	public Result<?> edit(@RequestBody ErpYljcJgkhjldkkhzbtj erpYljcJgkhjldkkhzbtj) {
		erpYljcJgkhjldkkhzbtjService.updateById(erpYljcJgkhjldkkhzbtj);
	 ...
	 * @return
	 */
	@AutoLog(value = "机构客户经理指标统计(机构)-通过id删除")
	@ApiOperation(value="机构客户经理指标统计(机构)-通过id删除", notes="机构客户经理指标统计(机构)-通过id删除")
	@DeleteMapping(value = "/delete")
	public Result<?> delete(@RequestParam(name="id",required=true) String id) {
		erpYljcJgkhjldkkhzbtjService.removeById(id);
	 ...
	 * @return
	 */
	@AutoLog(value = "机构客户经理指标统计(机构)-批量删除")
	@ApiOperation(value="机构客户经理指标统计(机构)-批量删除", notes="机构客户经理指标统计(机构)-批量删除")
	@DeleteMapping(value = "/deleteBatch")
	public Result<?> deleteBatch(@RequestParam(name="ids",required=true) String ids) {
		this.erpYljcJgkhjldkkhzbtjService.removeByIds(Arrays.asList(ids.split(",")));
	 ...
	 * @return
	 */
	@AutoLog(value = "机构客户经理指标统计(机构)-通过id查询")
	@ApiOperation(value="机构客户经理指标统计(机构)-通过id查询", notes="机构客户经理指标统计(机构)-通过id查询")
	@GetMapping(value = "/queryById")
	public Result<?> queryById(@RequestParam(name="id",required=true) String id) {
		ErpYljcJgkhjldkkhzbtj erpYljcJgkhjldkkhzbtj = erpYljcJgkhjldkkhzbtjService.getById(id);
		return Result.ok(erpYljcJgkhjldkkhzbtj);
	}
  ...
  public ModelAndView exportXls(HttpServletRequest request, ErpYljcJgkhjldkkhzbtj erpYljcJgkhjldkkhzbtj) {
	  // Step.1 组装查询条件
	  QueryWrapper<ErpYljcJgkhjldkkhzbtj> queryWrapper = QueryGenerator.initQueryWrapper(erpYljcJgkhjldkkhzbtj, request.getParameterMap());
	  queryWrapper.and(i -> i.gt("ckye",0)
			  .or().gt("dkye",0)
			  .or().gt("cknrpye",0)
			  .or().gt("dkrpye",0)
	  ...
	  // Step.2 获取导出数据
	  List<ErpYljcJgkhjldkkhzbtj> pageList = service.list(queryWrapper);
	  // 过滤选中数据
	  // Step.3 AutoPoi 导出Excel
	  ModelAndView mv = new ModelAndView(new JeecgEntityExcelView());
	  mv.addObject(NormalExcelConstants.FILE_NAME, "客户经理存贷款统计(机构)"); //此处设置的filename无效 ,前端会重更新设置一下
	  mv.addObject(NormalExcelConstants.CLASS, ErpYljcJgkhjldkkhzbtj.class);
	  mv.addObject(NormalExcelConstants.PARAMS, new ExportParams("客户经理存贷款统计(机构)" + "报表", "导出人:" + sysUser.getRealname(), "机构客户经理指标统计(机构)"));
	  mv.addObject(NormalExcelConstants.DATA_LIST, pageList);
	  return mv;
      //return super.exportXls(request, erpYljcJgkhjldkkhzbtj, ErpYljcJgkhjldkkhzbtj.class, "机构客户经理指标统计(机构)");
  }
  ...
  public Result<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
      return super.importExcel(request, response, ErpYljcJgkhjldkkhzbtj.class);
  }
