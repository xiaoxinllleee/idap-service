package org.cmms.modules.ywgl.cdkfx.khjlcdktjjg.entity;
 ...
 */
@Data
@TableName("Erp_yljc_jgkhjldkkhzbtj")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Erp_yljc_jgkhjldkkhzbtj对象", description="机构客户经理指标统计(机构)")
public class ErpYljcJgkhjldkkhzbtj {
	/**统计月份*/
	...
	private Date tjyf;
	/**业务机构代码*/
	@Excel(name = "业务机构名称", width = 15,dicCode = "ywjgdm", dictTable = "HR_BAS_ORGANIZATION", dicText = "zzjc")
	...
	private Date endday;
	/**员工所在机构*/
	@Excel(name = "员工所在机构", width = 15,dicCode = "ywjgdm", dictTable = "HR_BAS_ORGANIZATION", dicText = "zzjc")
    @ApiModelProperty(value = "员工机构代码")
	@Dict(dicCode = "ywjgdm", dictTable = "HR_BAS_ORGANIZATION", dicText = "zzjc")
	private String jgdm;
	/**员工工号*/
