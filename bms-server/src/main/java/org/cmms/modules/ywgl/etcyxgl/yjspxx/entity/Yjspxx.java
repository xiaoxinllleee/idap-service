package org.cmms.modules.ywgl.etcyxgl.yjspxx.entity;
...
@ApiModel(value="Erp_bas_etcyxspxx对象", description="移交审批信息")
public class Yjspxx {

	/**营业网点机构码*/
	@Excel(name = "营业网点机构码", width = 15,dicCode = "ywjgdm", dictTable = "HR_BAS_ORGANIZATION", dicText = "zzjc")
    @ApiModelProperty(value = "营业网点机构码")
	...
	private String blqd;
	/**移交人工号*/
	@Excel(name = "移交人工号", width = 15)
	@ApiModelProperty(value = "移交人工号")
	...
	private Date yjrq;
	/**接受管户人人工号*/
	@Excel(name = "接受管户人人工号", width = 15,dicCode = "yggh",dictTable = "Hr_bas_staff",dicText = "ygxm")
	@ApiModelProperty(value = "接受管户人人工号")
