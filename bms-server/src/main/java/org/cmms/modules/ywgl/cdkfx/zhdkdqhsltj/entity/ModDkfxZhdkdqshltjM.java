package org.cmms.modules.ywgl.cdkfx.zhdkdqhsltj.entity;
 ...
 */
@Data
@TableName("MOD_DKFX_ZHDKDQSHLTJ_M")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="MOD_DKFX_ZHDKDQSHLTJ_M对象", description="支行贷款到期收回率")
public class ModDkfxZhdkdqshltjM {
	/**统计月份*/
	...
	/**以前发放已收回(元)*/
	@Excel(name = "以前发放已收回(元)", width = 15)
	@ApiModelProperty(value = "以前发放已收回(元)")
