package org.cmms.modules.ywgl.etcyxgl.zhetcyxtj.entity;
 ...
 */
@Data
@TableName("ERP_BAS_ZHETCYXTJ")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="ERP_BAS_ZHETCYXTJ对象", description="支行etc营销统计")
public class Zhetcyxtj {
