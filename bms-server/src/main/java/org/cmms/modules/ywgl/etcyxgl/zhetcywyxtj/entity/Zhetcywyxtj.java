package org.cmms.modules.ywgl.etcyxgl.zhetcywyxtj.entity;
 ...
 */
@Data
@TableName("ERP_BAS_ZHETCYWYXTJ")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="ERP_BAS_ZHETCYWYXTJ对象", description="支行etc业务营销统计")
public class Zhetcywyxtj {
