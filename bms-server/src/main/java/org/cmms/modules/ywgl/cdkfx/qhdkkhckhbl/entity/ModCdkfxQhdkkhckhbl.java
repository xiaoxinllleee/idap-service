package org.cmms.modules.ywgl.cdkfx.qhdkkhckhbl.entity;
 ...
 */
@Data
@TableName("MOD_CDKFX_QHDKKHCKHBL")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="MOD_CDKFX_QHDKKHCKHBL对象", description="全行贷款客户存款回报率")
public class ModCdkfxQhdkkhckhbl {
	/**统计日期*/
