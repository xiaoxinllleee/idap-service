package org.cmms.modules.ywgl.cdkfx.zhcdktj.entity;
 ...
 */
@Data
@TableName("Erp_yljc_zhcdktj")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Erp_yljc_zhcdktj对象", description="支行存贷款统计")
public class ErpYljcZhcdktj {
