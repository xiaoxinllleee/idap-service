package org.cmms.modules.ywgl.cdkfx.khjlcdktjzh.entity;
 ...
 */
@Data
@TableName("Erp_yljc_zhkhjldkkhzbtj")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Erp_yljc_zhkhjldkkhzbtj对象", description="客户经理指标统计(支行)")
public class ErpYljcZhkhjldkkhzbtj {
	/**统计月份*/
