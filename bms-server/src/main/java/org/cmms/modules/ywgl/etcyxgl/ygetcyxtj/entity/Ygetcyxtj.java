package org.cmms.modules.ywgl.etcyxgl.ygetcyxtj.entity;
 ...
 */
@Data
@TableName("ERP_BAS_YGETCYXTJ")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="ERP_BAS_YGETCYXTJ对象", description="员工etc营销统计")
public class Ygetcyxtj {
