...
import org.cmms.modules.xyjlcx.xybg.xybgcx.vo.JbxxSfxx;
...
@Api(tags = "信用报告查询")
@RestController
@RequestMapping("/creditreportquery")
public class CreditReportQueryController extends JeecgController<Cxjltz, ICreditReportQueryService> {
    @Autowired
    ...
    public Result<?> query(@RequestParam(name = "bcxrzjhm", required = true) String bcxrzjhm,
        ...
        try {
            ...
            CompletableFuture<String> completableFuture2 = CompletableFuture.supplyAsync(() -> {
                ...
                try {
                    //先查询信贷系统个人基本信息表
                    Khxxb grkhjbxx = iKhxxbService.getKhxxbHive(bcxrzjhm);
                    if (grkhjbxx != null) {
    ...
    public Result<?> report(@RequestParam(name = "bgbh", required = true) String bgbh,
        ...
        //大数据每日跑批，只要oracle 需要调用存储
        if ("false".equals(sfdsjpt)) {
        ...
        try {
            ...
            CompletableFuture<JSONObject> completableFuture1 = CompletableFuture.supplyAsync(() -> {
                ...
                try {
                    ...
                    //先查询信贷系统个人基本信息表
                    Khxxb grkhjbxx = iKhxxbService.getKhxxbHive(zjhm);
                    if (grkhjbxx != null) {
                        xm1 = grkhjbxx.getCustName();
                        jgdm = grkhjbxx.getCreateBranchNo();
                        Grkhb grxx = iGrkhbService.getGrkhbHive(grkhjbxx.getCustId());
                        if (grxx != null) {
            ...
            CompletableFuture<JSONObject> completableFuture4 = CompletableFuture.supplyAsync(() -> {
                ...
                try {
                   /* Long timeConsumingStart_4 = System.currentTimeMillis();
                    ...
                    //信息概要-信用提示
                    List<TmpCreditXytssjVO> tmpCreditXytssj = new ArrayList<>();
                    List<Xyts> creditXytssj = new ArrayList<>();
                    QueryWrapper<Xyts> queryWrapper = new QueryWrapper();
                    queryWrapper.eq("zjhm", zjhm);
                    creditXytssj = xytsService.list(queryWrapper);

                    creditXytssj = listToDictUtil.parseDictText(creditXytssj);
                    jsonObject.put("xytsTable", creditXytssj);
            ...
            CompletableFuture<JSONArray> completableFuture5 = CompletableFuture.supplyAsync(() -> {
                ...
                try {
                    ...
                    //int xh = 1;
                    List<Kjbxx> cbscCardList1 = iKjbxxService.getBmkxxHive(zjhm);
                    ...
                    for (Dkkhglrgl form : dkkhglrgl) {
                        ...
                        List<Kjbxx> cbscCardList2 = iKjbxxService.getBmkxxHive(glrzjhm);
            ...
            CompletableFuture<JSONObject> completableFuture8 = CompletableFuture.supplyAsync(() -> {
                ...
                try {
                    ...
                    bwdksjmxList = iBwdksjmxService.queryBwtmdkHive(xm, csnf, String.valueOf(nf));
                    ...
                    for (Dkkhglrgl form : dkkhglrgl) {
                        String glrxm = form.getGlrxm();
                        bwdksjmxList = iBwdksjmxService.queryBwtmdkHive(glrxm, csnf, String.valueOf(nf));
            ...
            CompletableFuture<JSONObject> completableFuture10 = CompletableFuture.supplyAsync(() -> {
                ...
                try {
                    ...
                    List<TmpCreditDksjVO> tmpCreditDksj = iCreditReportQueryService.getDksjmxHive(zjhm);
                    Long endTime1 = System.currentTimeMillis();
                    log.info("##############10.异步信用报告查询-贷款数据##############查询贷款数据耗时：" + (endTime1 - beginTime1) / 1000 + " (s)");

                    QueryWrapper<Qxmx> queryWrapper = new QueryWrapper();
                    queryWrapper.eq("ident_no", zjhm);
                    queryWrapper.orderByAsc("yqyf");
                    List<Qxmx> listQxmx = qxmxService.list(queryWrapper);
                    ...
                    if ("true".equals(sfdsjpt)) {
                        sjgxr = DateUtil.string2Date(iSysLogService.cksjrqBig(), "yyyyMMdd");//Hive
                    } else {
            ...
            CompletableFuture<JSONObject> completableFuture12 = CompletableFuture.supplyAsync(() -> {
                ...
                try {
                    ...
                    QueryWrapper<Dksj> queryWrapper = new QueryWrapper<>();
                    queryWrapper.eq("dbrzjhm", zjhm);
                    queryWrapper.ne("zjhm", zjhm);
                    dbxxHive = dksjService.list(queryWrapper);
                    for (Dksj form : dbxxHive) {
                    ...
                    if ("true".equals(sfdsjpt)) {
                        dbxxHive = listToDictUtil.parseDictText(dbxxHive);
                        jsonObject.put("dbxxTable", dbxxHive);
                    } else {
    ...
    public JSONObject check(String xm, String zjhm, String bgbh, String cxjgdm, String csnf, String glrxm, List<Bwdksjmx> bwtmdk) {
        ...
        try {
            ...
            List<Bwdksjmx> bwdksjmx = iBwdksjmxService.queryBwtmdkHive(khmc, csnf, String.valueOf(nf));
...
//                        }
            ...
            CompletableFuture<JSONArray> qtxxgyCompletableFuture = CompletableFuture.supplyAsync(() -> {
                ...
                try {
                    ...
                    // 被查询人
                    // P1.福祥便民卡
                    List<Kjbxx> cbscCardList = iKjbxxService.getBmkxxHive(zjhm);
                    ...
                    List<Bwdksjmx> bwdksjmxListFilter = new ArrayList<>();
                    List<Bwdksjmx> bwdksjmxList = iBwdksjmxService.queryBwtmdkHive(name, csnf, String.valueOf(nf));
                    ...
                    if (nhxx != null) {
                        ...
                        for (JbxxGlrxx glrxx : jbxxGlrxxList) {
                            // P1.福祥便民卡
                            cbscCardList = iKjbxxService.getBmkxxHive(glrxx.getZjhm());
                            for (Kjbxx kjbxx : cbscCardList) {
                                stringBuilder = new StringBuilder();
                                String ywjgdm = kjbxx.getIssueBranch().toString();
                                if (ywjgdm.length() == 4) {
                            ...
                            csnfInt = Integer.parseInt(csnf);
                            bwdksjmxListFilter = new ArrayList<>();
                            bwdksjmxList = iBwdksjmxService.queryBwtmdkHive(glrxx.getKhmc(), csnf, String.valueOf(nf));
                            for (Bwdksjmx record : bwdksjmxList) {
                                Bwdksjmx bwdksjmx = new Bwdksjmx();
                                BeanUtil.copyPropertiesIgnoreNull(record, bwdksjmx);
                                Date dkrq = bwdksjmx.getDkrq();
            ...
            CompletableFuture<JSONObject> dksjCompletableFuture = CompletableFuture.supplyAsync(() -> {
                ...
                try {
                    ...
                    BigDecimal hxyeSum = new BigDecimal(0);
                    //欠息逾期明细
                    QueryWrapper<Qxmx> qxmxQueryWrapper = new QueryWrapper<>();
                    qxmxQueryWrapper.eq("ident_no", zjhm);
                    qxmxQueryWrapper.orderByAsc("yqyf");
                    List<Qxmx> listQxmx = qxmxService.list(qxmxQueryWrapper);
...
//        }
        ...
        try {
            ...
            List<Bwdksjmx> bwdksjmxListFilter = new ArrayList<>();
            List<Bwdksjmx> bwdksjmxList = iBwdksjmxService.queryBwtmdkHive(nhxx.getKhmc(), csnf, String.valueOf(nf));
            for (Bwdksjmx record : bwdksjmxList) {
                Bwdksjmx bwdksjmx = new Bwdksjmx();
                BeanUtil.copyPropertiesIgnoreNull(record, bwdksjmx);
                Date dkrq = bwdksjmx.getDkrq();
        ...
        try {
            ...
            if (sfzszxbg == null || "1".equals(sfzszxbg)) {
                ...
                if (CollUtil.isNotEmpty(list)) {
                    ...
                    if (org.apache.commons.lang3.StringUtils.isNotBlank(zxbgPdfImg.getWljl()) && cn.hutool.core.io.FileUtil.isFile(zxbgPdfImg.getWljl()) && zxbgPdfImg.getWljl().contains("html")) {
                        BufferedReader utf8Reader = cn.hutool.core.io.FileUtil.getUtf8Reader(zxbgPdfImg.getWljl());
