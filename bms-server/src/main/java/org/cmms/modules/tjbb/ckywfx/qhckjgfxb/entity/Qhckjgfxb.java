package org.cmms.modules.tjbb.ckywfx.qhckjgfxb.entity;
 ...
 */
@Data
@TableName("TJBB_CKYW_CKJGFXB_QH")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="TJBB_CKYW_CKJGFXB_QH对象", description="全行存款结构分析表")
public class Qhckjgfxb {
