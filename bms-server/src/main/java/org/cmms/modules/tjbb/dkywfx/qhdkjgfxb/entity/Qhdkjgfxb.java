package org.cmms.modules.tjbb.dkywfx.qhdkjgfxb.entity;
 ...
 */
@Data
@TableName("TJBB_DKYW_DKJGFXB_QH")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="TJBB_DKYW_DKJGFXB_QH对象", description="全行贷款结构分析表")
public class Qhdkjgfxb {
