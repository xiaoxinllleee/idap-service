package org.cmms.modules.report.tzsjgl.gtgsh.entity;
 ...
 */
@Data
@TableName("ERP_TZGL_XT_GTGSH")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="ERP_TZGL_XT_GTGSH对象", description="个体工商户")
public class SgtzGtgsh {
	/**数据日期*/
