package org.cmms.modules.report.tzsjgl.nyzqhzdjb.entity;
 ...
 */
@Data
@TableName("REP_TZGL_NY_ZQHZDJB")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="REP_TZGL_NY_ZQHZDJB对象", description="宁远债券汇总登记簿")
public class Nyzqhzdjb {
	/**数据日期*/
	...
	private String zqcddm;
	/**债券（存单）简称*/
	@Excel(name = "债券（存单）简称", width = 15)
    @ApiModelProperty(value = "债券（存单）简称")
	private String zqcdjc;
	/**法行主体*/
	@Excel(name = "法行主体", width = 15)
    @ApiModelProperty(value = "法行主体")
	private String xfzt;
	/**是否含权*/
	...
	/**购入日*/
	@Excel(name = "购入日", width = 15)
    @ApiModelProperty(value = "购入日")
	private String grr;
	/**券面总额（元）*/
	...
	/**初始购入全份（元/百元）*/
	@Excel(name = "初始购入全份（元/百元）", width = 15)
    @ApiModelProperty(value = "初始购入全份（元/百元）")
	private java.math.BigDecimal csgrqf;
	/**初始购入净价（元/百元）*/
	...
	private java.math.BigDecimal cyzdqsy;
	/**交易类型*/
	...
	private java.math.BigDecimal gxjzbdye;
	/**利息调整余额（元）*/
	@Excel(name = "利息调整余额（元）", width = 15)
    @ApiModelProperty(value = "利息调整余额（元）")
	private java.math.BigDecimal lxdzye;
	/**应收利息余额（元）*/
	...
	private java.math.BigDecimal dqpm;
	/**剩余年限*/
	...
	private java.math.BigDecimal fdykbl;
	/**部分卖出金额（元）*/
