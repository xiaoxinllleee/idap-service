package org.cmms.modules.report.sgtzgl.dkqmxgtgsh.entity;
...
/**
 * @Description: 贷款全明细-个体工商户
 * @Author: jeecg-boot
 * @Date:   2022-09-30
 * @Version: V1.0
 */
@Data
@TableName("ads_rep_sgtz_dkqmx_gtgshdk")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="ads_rep_sgtz_dkqmx_gtgshdk对象", description="贷款全明细-个体工商户")
public class SgtzglDkqmxGtgsh {
