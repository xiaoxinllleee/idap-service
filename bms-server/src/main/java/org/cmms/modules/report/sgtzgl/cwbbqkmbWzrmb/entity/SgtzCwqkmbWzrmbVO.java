package org.cmms.modules.report.sgtzgl.cwbbqkmbWzrmb.entity;
 ...
 */
@Data
@TableName("ads_rep_sgtz_cwqkmb_wzrmb")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="ads_rep_sgtz_cwqkmb_wzrmb对象", description="财务报表全科目表-外折人民币")
public class SgtzCwqkmbWzrmbVO {
