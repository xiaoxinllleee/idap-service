package org.cmms.modules.report.sgtzgl.cwbbzcfzbWzrmb.entity;
 ...
 */
@Data
@TableName("ads_rep_sgtz_cwxyszcfzb_wzrmb")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="ads_rep_sgtz_cwxyszcfzb_wzrmb对象", description="财务报表资产负债表-外折人民币")
public class SgtzCwxyszcfzbWzrmb {
