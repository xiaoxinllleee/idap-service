package org.cmms.modules.report.zbgl.qyzbsjx.entity;
 ...
 */
@Data
@TableName("REP_INDEX_SJX_AREA")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="REP_INDEX_SJX_AREA对象", description="区域指标数据项管理")
public class Qyzbsjxgl {
