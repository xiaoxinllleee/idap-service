package org.cmms.modules.report.zbgl.zbtqrzcx.entity;
 ...
 */
@Data
@TableName("REP_INDEX_EXECUTE_LOG")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="REP_INDEX_EXECUTE_LOG对象", description="指标提取日志查询")
public class RepIndexExecuteLog {
