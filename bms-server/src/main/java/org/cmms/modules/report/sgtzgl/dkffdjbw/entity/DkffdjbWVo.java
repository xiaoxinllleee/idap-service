package org.cmms.modules.report.sgtzgl.dkffdjbw.entity;
 ...
 */
@Data
@TableName("ADS_REP_SGTZ_XDB_DKFFDJB_W")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="ADS_REP_SGTZ_XDB_DKFFDJB_W对象", description="贷款发放登记簿（周）")
public class DkffdjbWVo {
