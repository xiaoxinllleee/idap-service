package org.cmms.modules.report.sgtzgl.cwbbywzkbRmb.entity;
 ...
 */
@Data
@TableName("ads_rep_sgtz_cwywzkb_rmb")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="ads_rep_sgtz_cwywzkb_rmb对象", description="财务报表业务状况表-人民币")
public class SgtzCwbbywzkbRmb {
