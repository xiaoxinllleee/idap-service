package org.cmms.modules.report.sgtzgl.cwbbywzkb.entity;
 ...
 */
@Data
@TableName("ads_rep_sgtz_cwywzkb_bwb")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="ads_rep_sgtz_cwywzkb_bwb对象", description="财务报表业务状况表-本外币")
public class SgtzCwbbywzkb {
