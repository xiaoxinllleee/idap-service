package org.cmms.modules.report.sgtzgl.cwbbbwkmbRmb.entity;
 ...
 */
@Data
@TableName("ads_rep_sgtz_cwxysbwkmb_rmb")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="ads_rep_sgtz_cwxysbwkmb_rmb对象", description="财务报表表外科目表-人民币")
public class SgtzcwbwkmbRmb {
