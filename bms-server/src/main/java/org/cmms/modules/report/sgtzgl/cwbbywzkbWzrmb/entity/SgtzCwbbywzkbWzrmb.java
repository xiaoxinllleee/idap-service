package org.cmms.modules.report.sgtzgl.cwbbywzkbWzrmb.entity;
 ...
 */
@Data
@TableName("ads_rep_sgtz_cwywzkb_wzrmb")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="ads_rep_sgtz_cwywzkb_wzrmb对象", description="财务报表业务状况表-外折人民币")
public class SgtzCwbbywzkbWzrmb {
