package org.cmms.modules.report.sgtzgl.cwbbbwkmb.entity;
 ...
 */
@Data
@TableName("ads_rep_sgtz_cwbwkmb_bwb")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="ads_rep_sgtz_cwbwkmb_bwb对象", description="财务报表表外科目表-本外币")
public class SgtzCwbbbwkmb {
