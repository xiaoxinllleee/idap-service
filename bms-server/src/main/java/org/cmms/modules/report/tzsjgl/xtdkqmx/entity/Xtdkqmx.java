package org.cmms.modules.report.tzsjgl.xtdkqmx.entity;
 ...
 */
@Data
@TableName("rep_tzgl_xt_dkqmx")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="rep_tzgl_xt_dkqmx对象", description="湘潭贷款全明细")
public class Xtdkqmx {
	/**数据日期*/
	...
	/**单户余额*/
	@Excel(name = "单户余额", width = 15)
    @ApiModelProperty(value = "单户余额")
	private java.math.BigDecimal dhye;
	/**贷款日期*/
...
*/
	...
	private java.lang.String scjxq;
	/**贷款年利率%*/
