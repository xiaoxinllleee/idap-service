package org.cmms.modules.report.sgtzgl.cwbbsybbWzrmb.entity;
 ...
 */
@Data
@TableName("ads_rep_sgtz_cwxyssyb_wzrmb")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="ads_rep_sgtz_cwxyssyb_wzrmb对象", description="财务报表损益报表-外折人民币")
public class SgtzCwxyssybWzrmb {
