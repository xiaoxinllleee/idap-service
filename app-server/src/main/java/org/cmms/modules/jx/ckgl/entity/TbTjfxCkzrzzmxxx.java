package org.cmms.modules.jx.ckgl.entity;
 ...
 */
@Data
@TableName("tb_tjfx_ckzrzzmxxx")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="tb_tjfx_ckzrzzmxxx对象", description="存款拓展明细信息")
public class TbTjfxCkzrzzmxxx {
