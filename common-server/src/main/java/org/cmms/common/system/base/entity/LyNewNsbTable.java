 ...
 * @Created by eran
 */
public class LyNewNsbTable {
    private HSSFWorkbook workbook;

    private HSSFSheet sheet;

    public LyNewNsbTable(HSSFWorkbook workbook, HSSFSheet sheet) {
    ...
    public void setTableName(String tableName) {
        ...
        this.createCellRange(sheet, 0, 0, 0, 17, true);
    ...
    public void setRowTwoNam(String yxdy) {
        ...
        this.createCell(sheet, cellStyle, row, 17, "单位：万元", false);
        this.createCellRange(sheet, 1, 1, 0, 0, true);
        this.createCellRange(sheet, 1, 1, 1, 16, true);
        this.createCellRange(sheet, 1, 1, 17, 17, true);
    }
    ...
    public void setTableFooter() {
        ...
        this.createCellRange(sheet, rowIndex, rowIndex, 13, 16, true);
        ...
        sheet.setDefaultColumnStyle(13, cs);
