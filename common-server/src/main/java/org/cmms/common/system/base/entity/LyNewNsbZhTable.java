 ...
 * @Created by eran
 */
public class LyNewNsbZhTable {
    private HSSFWorkbook workbook;

    private HSSFSheet sheet;

    public LyNewNsbZhTable(HSSFWorkbook workbook, HSSFSheet sheet) {
    ...
    public void setTableName(String tableName) {
        ...
        this.createCellRange(sheet, 0, 0, 0, 19, true);
...
//        this.createCell(sheet, cellStyle, row, 1, yxdy, false);
        this.createCell(sheet, cellStyle, row, 19, "单位：万元", false);
//        this.createCellRange(sheet, 1, 1, 0, 0, true);
//        this.createCellRange(sheet, 1, 1, 1, 16, true);
        this.createCellRange(sheet, 1, 1, 19, 19, true);
    }
    ...
    public void setTableHeader() {
        ...
        list.add("原信用等级");
        list.add("原授信金额");
        list.add("信贷系统公开授信使用总金额");
        list.add("信贷系统公开授冻结金额");
        list.add("现贷款金额");
        list.add("现贷款余额");
        list.add("近三年存款日平");
        list.add("表内不良");
    ...
    public void setTableFooter() {
        ...
        row.createCell(13).setCellValue(new HSSFRichTextString(StringUtils.join("支行行长签字：", "\n\n\n", StringUtils.repeat(" ", 20), "年    月    日")));
        CellUtil.getCell(row, 13).setCellStyle(cellStyle);


        this.createCellRange(sheet, rowIndex, rowIndex, 0, 3, true);
        this.createCellRange(sheet, rowIndex, rowIndex, 4, 12, true);
        this.createCellRange(sheet, rowIndex, rowIndex, 13, 19, true);
        ...
        sheet.setDefaultColumnStyle(19, cs);
