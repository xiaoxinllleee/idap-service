...
public class ForEachCommand extends AbstractCommand {
     ...
     */
    public ForEachCommand(String var, String items, Direction direction) {
        this.var = var;
        this.items = items;
        this.direction = direction == null ? Direction.DOWN : direction;
    }

    public ForEachCommand(String var, String items, Area area) {
        this(var, items, area, Direction.DOWN);
    }

    public ForEachCommand(String var, String items, Area area, Direction direction) {
     ...
     */
    public ForEachCommand(String var, String items, Area area, CellRefGenerator cellRefGenerator) {
