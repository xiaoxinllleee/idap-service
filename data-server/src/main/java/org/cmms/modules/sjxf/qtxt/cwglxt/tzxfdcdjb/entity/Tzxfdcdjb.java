package org.cmms.modules.sjxf.qtxt.cwglxt.tzxfdcdjb.entity;
 ...
 */
@Data
@TableName("Ebss_inv_prop_mst")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Ebss_inv_prop_mst对象", description="投资性房地产登记簿")
public class Tzxfdcdjb {
	...
	/**资产成本*/
	@Excel(name = "资产成本", width = 15)
    @ApiModelProperty(value = "资产成本")
	...
	/**折旧（或摊销）方式*/
	@Excel(name = "折旧（或摊销）方式", width = 15)
    @ApiModelProperty(value = "折旧（或摊销）方式")
	...
	/**折旧或摊销方式*/
	@Excel(name = "折旧或摊销方式", width = 15)
    @ApiModelProperty(value = "折旧或摊销方式")
	...
	/**已使用期限*/
	@Excel(name = "已使用期限", width = 15)
    @ApiModelProperty(value = "已使用期限")
	...
	/**折旧或分摊次数*/
	@Excel(name = "折旧或分摊次数", width = 15)
    @ApiModelProperty(value = "折旧或分摊次数")
	...
	/**后续计量方法*/
	@Excel(name = "后续计量方法", width = 15)
    @ApiModelProperty(value = "后续计量方法")
	...
	/**范围（投资性房地产使用）*/
	@Excel(name = "范围（投资性房地产使用）", width = 15)
    @ApiModelProperty(value = "范围（投资性房地产使用）")
	...
	/**关联土地使用权编号*/
	@Excel(name = "关联土地使用权编号", width = 15)
    @ApiModelProperty(value = "关联土地使用权编号")
