package org.cmms.modules.sjxf.qtxt.wsyhxt.qykhjylsxx1.entity;
 ...
 */
@Data
@TableName("Ibss_cb_tranflow_noinvest")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Ibss_cb_tranflow_noinvest对象", description="企业客户交易流水信息(当天未经查证)")
public class Qykhjylsxx1 {
