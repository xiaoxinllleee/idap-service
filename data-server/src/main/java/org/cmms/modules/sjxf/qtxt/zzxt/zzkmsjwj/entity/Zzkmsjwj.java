package org.cmms.modules.sjxf.qtxt.zzxt.zzkmsjwj.entity;
 ...
 */
@Data
@TableName("Tgls_glsbusiness_info")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Tgls_glsbusiness_info对象", description="总帐科目数据文件")
public class Zzkmsjwj {
