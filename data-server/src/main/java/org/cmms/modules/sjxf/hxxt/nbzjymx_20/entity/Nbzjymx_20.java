package org.cmms.modules.sjxf.hxxt.nbzjymx_20.entity;
 ...
 */
@Data
@TableName("Cbs_gect_tran_20")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Cbs_gect_tran_20对象", description="内部帐交易明细_20")
public class Nbzjymx_20 {
