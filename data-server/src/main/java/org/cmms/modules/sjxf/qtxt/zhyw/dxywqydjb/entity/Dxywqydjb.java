package org.cmms.modules.sjxf.qtxt.zhyw.dxywqydjb.entity;
 ...
 */
@Data
@TableName("Fbuss_tz_dxqyxxdjb")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Fbuss_tz_dxqyxxdjb对象", description="短信业务签约登记簿")
public class Dxywqydjb {
