package org.cmms.modules.sjxf.qtxt.khxxst.grzjxx.entity;
 ...
 */
@Data
@TableName("ECIF_PER_IDENTIFIER")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="ECIF_PER_IDENTIFIER对象", description="个人证件信息")
public class Grzjxx {
	...
	private String identModifiedFlag;
	/**证件修改时间*/
