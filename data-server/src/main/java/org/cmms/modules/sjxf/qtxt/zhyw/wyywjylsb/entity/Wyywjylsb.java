package org.cmms.modules.sjxf.qtxt.zhyw.wyywjylsb.entity;
 ...
 */
@Data
@TableName("Fbuss_ebank_trade_log")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Fbuss_ebank_trade_log对象", description="网银业务交易流水表")
public class Wyywjylsb {
	...
	/**报文号*/
	@Excel(name = "报文号", width = 15)
    @ApiModelProperty(value = "报文号")
