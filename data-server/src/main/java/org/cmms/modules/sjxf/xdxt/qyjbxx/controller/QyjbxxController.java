package org.cmms.modules.sjxf.xdxt.qyjbxx.controller;
...
import org.cmms.modules.sjxf.xdxt.qyjbxx.entity.Qyjbxx;
import org.cmms.modules.sjxf.xdxt.qyjbxx.service.IQyjbxxService;
...
@Api(tags="企业基本信息")
@RestController
@RequestMapping("/qyjbxx/qyjbxx")
public class QyjbxxController extends JeecgController<Qyjbxx, IQyjbxxService> {
	@Autowired
	...
	public Result<?> queryPageList(Qyjbxx qyjbxx,
		...
		IPage pageList=org.cmms.common.utils.PageUtil.toPage(IQyjbxxService.class,qyjbxxService,pageNo,pageSize,queryWrapper,"ent_info_id");
	...
	public Result<?> edit(@RequestBody Qyjbxx qyjbxx) {
		qyjbxxService.updateById(qyjbxx);
	...
	public Result<?> deleteBatch(@RequestParam(name="ids",required=true) String ids) {
		this.qyjbxxService.removeByIds(Arrays.asList(ids.split(",")));
	...
	public Result<?> queryById(@RequestParam(name="id",required=true) String id) {
		Qyjbxx qyjbxx = qyjbxxService.getById(id);
  ...
  public ModelAndView exportXls(HttpServletRequest request, Qyjbxx qyjbxx) {
      return super.exportXls(request, qyjbxx, Qyjbxx.class, "企业基本信息");
  }
