package org.cmms.modules.sjxf.hxxt.ckls_49.entity;import java.io.Serializable;import java.util.Date;import com.baomidou.mybatisplus.annotation.IdType;import com.baomidou.mybatisplus.annotation.TableId;import com.baomidou.mybatisplus.annotation.TableName;import com.baomidou.mybatisplus.annotation.TableField;import io.swagger.annotations.ApiModel;import io.swagger.annotations.ApiModelProperty;import lombok.Data;import lombok.EqualsAndHashCode;import lombok.experimental.Accessors;import com.fasterxml.jackson.annotation.JsonFormat;import org.springframework.format.annotation.DateTimeFormat;import org.jeecgframework.poi.excel.annotation.Excel;/*** @Description: 存款流水_49* @Author: jeecg-boot* @Date:   2021-12-09* @Version: V1.0*/@Data
@TableName("Cbs_inct_tran_49")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value="Cbs_inct_tran_49对象", description="存款流水_49")
public class Ckls_49 {
	...
	private String deli;
	/**转机构时的当前余额*/
	@Excel(name = "转机构时的当前余额", width = 15)
    @ApiModelProperty(value = "转机构时的当前余额")
	private String capital;
	/**转机构时的当前累计利息*/
	@Excel(name = "转机构时的当前累计利息", width = 15)
    @ApiModelProperty(value = "转机构时的当前累计利息")
	...
	/**标识是否为透支户*/
	@Excel(name = "标识是否为透支户", width = 15)
    @ApiModelProperty(value = "标识是否为透支户")
	private String odAcct;
	/**filler*/
